...
// reference path = mapped OpenMP logic from lines 453-494,
// with compute-equivalent core at lines 471-494.
static int run_case(int n_particles, int trial_seed) {
    ...
    find_index_kernel(cdf, u, array_x, array_y, xj_hw, yj_hw, n_particles);
